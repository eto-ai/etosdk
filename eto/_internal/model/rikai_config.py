...
class RikaiConfig(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, dataset_name, url, *args, **kwargs):  # noqa: E501
        """RikaiConfig - a model defined in OpenAPI

        Args:
            dataset_name (str): the name of the dataset to be created
            url (str): the url of the rikai directory
    ...
    @convert_js_args_to_python_args
    def __init__(self, dataset_name, url, *args, **kwargs):  # noqa: E501
        """RikaiConfig - a model defined in OpenAPI
