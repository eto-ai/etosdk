...
class AccountsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_project_endpoint = _Endpoint(
            settings={
                ...
                "auth": [],
                "endpoint_path": "/api/v1/projects/{project}",
        ...
        self.get_token_endpoint = _Endpoint(
            settings={
                ...
                "auth": [],
                "endpoint_path": "/api/v1/accounts/token",
        ...
        self.regenerate_token_endpoint = _Endpoint(
            settings={
                "response_type": (
                    bool,
                    date,
    ...
    def create_project(self, project, body, **kwargs):
        """Create project with project name  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_project(project, body, async_req=True)
        >>> result = thread.get()
    ...
    def get_token(self, **kwargs):
        """Get API token for the current authenticated user.  # noqa: E501
    ...
    def regenerate_token(self, **kwargs):
        """Re-generate a token for user  # noqa: E501
