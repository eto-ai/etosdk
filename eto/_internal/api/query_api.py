...
class QueryApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_query_endpoint = _Endpoint(
            settings={
                ...
                "auth": [],
                "endpoint_path": "/api/v1/query/{query_id}",
        ...
        self.get_resultset_endpoint = _Endpoint(
            settings={
                "response_type": (ResultSet,),
                "auth": [],
                "endpoint_path": "/api/v1/query/{query_id}/results",
                "operation_id": "get_resultset",
                "http_method": "GET",
                "servers": None,
            },
            params_map={
    ...
    def get_query(self, query_id, **kwargs):
        """Get the status of a query.  # noqa: E501
    ...
    def get_resultset(self, query_id, **kwargs):
        """Retrieve query results set  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_resultset(query_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs["_request_auths"] = kwargs.get("_request_auths", None)
        kwargs["query_id"] = query_id
        return self.get_resultset_endpoint.call_with_http_info(**kwargs)
